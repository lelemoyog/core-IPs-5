...
public class AnimalTest {
    ...
    public void Animal_instantiatesCorrectly_true() {
        Animal testAnimal = new Animal( "elephant","Tsavo",1);
    ...
    public void equals_returnsTrueIfNameAndIdAreSame_true() {
        Animal testAnimal = new Animal( "elephant","Tsavo",1);
        Animal anotherAnimal = new Animal( "elephant","Tsavo",1);
    ...
    public void all_returnsAllInstancesOfAnimal_true() {
        Animal testAnimal = new Animal( "elephant","Tsavo",1);
        testAnimal.save();
        Animal otherAnimal = new Animal( "elephant","Tsavo",1);
        otherAnimal.save();
...
//        assertEquals(savedAnimal.getRangerId(), testAnimal.getId());
//    }
    @Test
